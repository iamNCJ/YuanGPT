...
class FlashGPT2Model(GPT2PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.h = nn.ModuleList([FlashGPT2Block(config, layer_idx=i) for i in range(config.num_hidden_layers)])
...
class FlashGPT2Block(nn.Module):
